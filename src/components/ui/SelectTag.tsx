...
import { SelectOption, SelectProps, SelectSize } from "@/types/ui/selectTagTypes";

export type { SelectProps, SelectOption, SelectSize };

const SIZE_CONFIG: Record<SelectSize, { paddingVertical: number; paddingHorizontal: number; fontSize: number }> = {
    sm: { paddingVertical: spacing.xs + 2, paddingHorizontal: spacing.md, fontSize: 13 },
    md: { paddingVertical: spacing.sm + 2, paddingHorizontal: spacing.md, fontSize: 15 },
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Text style={[styles.chevron, disabled && { color: colors.slate400 }]}>▾</Text>
            </Pressable>
                                ...
                                return (
                                    ...
                                    >
                                        <Text
                                            style={[
                                                styles.optionText,
                                                isSelected && { color: colors.brand600, fontFamily: typography.fontFamilySemiBold },
                                            ]}
                                        >
                                            {item.label}
                                        </Text>
