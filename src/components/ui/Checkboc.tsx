...
const SIZE_CONFIG: Record<CheckboxSize, { box: number; fontSize: number; glyphSize: number; gap: number }> = {
...
export function Checkbox({
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                >
                    {indeterminate ? (
                        ...
                        <Text style={{ fontFamily: typography.fontFamilyBold, fontSize: sizeConfig.glyphSize, color: colors.white }}>
                            ✓
                        </Text>
                    ) : null}
                </View>
            ...
            {errorText ? (
                <Text style={[styles.helperText, { color: colors.danger600 }]}>{errorText}</Text>
            ) : helperText ? (
